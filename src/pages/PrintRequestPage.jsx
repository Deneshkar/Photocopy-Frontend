    ...
    <div className="relative min-h-[calc(100vh-9rem)] overflow-hidden bg-gradient-to-br from-slate-50 to-brand-50/30">
      ...
      <div className="page-shell relative z-10 space-y-7 backdrop-blur-sm pt-8">
        <div className="rounded-2xl border border-white/50 bg-white/70 p-8 shadow-2xl backdrop-blur-xl">
          <h1 className="page-title text-3xl font-bold tracking-tight text-slate-900">Submit Print Request</h1>
          ...
          >
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                <label htmlFor="copies" className="label-ui">Number of Copies</label>
                <input
                  id="copies"
                  className="block w-full rounded-xl border-slate-200 bg-white/50 px-4 py-2.5 outline-none transition focus:border-brand-500 focus:bg-white focus:ring-2 focus:ring-brand-500/20"
                  type="number"
              ...
              <div>
                <label htmlFor="printType" className="label-ui">Print Type</label>
                <select
                  id="printType"
                  className="block w-full rounded-xl border-slate-200 bg-white/50 px-4 py-2.5 outline-none transition focus:border-brand-500 focus:bg-white focus:ring-2 focus:ring-brand-500/20"
                  name="printType"
          ...
          <div>
            <label htmlFor="paperSize" className="label-ui">Paper Size</label>
            <select
              id="paperSize"
              className="block w-full rounded-xl border-slate-200 bg-white/50 px-4 py-2.5 outline-none transition focus:border-brand-500 focus:bg-white focus:ring-2 focus:ring-brand-500/20"
              name="paperSize"
          ...
          <div>
            <label htmlFor="sides" className="label-ui">Print Sides</label>
            <select
              id="sides"
              className="block w-full rounded-xl border-slate-200 bg-white/50 px-4 py-2.5 outline-none transition focus:border-brand-500 focus:bg-white focus:ring-2 focus:ring-brand-500/20"
              name="sides"
          ...
          <div className="md:col-span-2">
            <label htmlFor="note" className="label-ui">Special Note</label>
            <textarea
              id="note"
              className="block w-full rounded-xl border-slate-200 bg-white/50 px-4 py-2.5 outline-none transition focus:border-brand-500 focus:bg-white focus:ring-2 focus:ring-brand-500/20"
              name="note"
        ...
        <div>
          <label htmlFor="file" className="label-ui">Select File</label>
          <div
            role="button"
            tabIndex={0}
            onDragOver={(e) => {
